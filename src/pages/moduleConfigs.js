...
export const trainingConfig = {
  ...
  search: ['training_title', 'category', 'provider', 'owner_function'],
  fields: [
    ...
    { name: 'owner_function', label: 'Budget Owner / Function', defaultValue: 'Unspecified', required: true },
    number('hc_cost', 'HC-funded Cost'), number('function_cost', 'Function-funded Cost'),
    select('tna_based', 'Based on TNA', [{ value: true, label: 'Yes' }, { value: false, label: 'No' }], true),
  ...
  columns: [
    ...
    { key: 'tna_based', label: 'TNA Based', render: (row) => row.tna_based ? 'Yes' : 'No' },
    { key: 'start_date', label: 'Start Date', kind: 'date' }, { key: 'participant_count', label: 'Participants' },
    { key: 'actual_cost', label: 'Used Budget', kind: 'currency' },
